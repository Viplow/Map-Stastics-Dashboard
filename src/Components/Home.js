  ...
  const onchangeCountry=async(e)=>{
   ...
   <MenuItem value="worldwide">3</MenuItem>*/}
                ...
                <Animated animationIn="fadeInUp">
                  <div className="app_stats">
                    <InfoBoxes
                      ...
                      className="today"
                      title="Today cases"
                      cases={numeral(Info.todayCases).format(0, 0)}
                    ...
                    <InfoBoxes
                      ...
                      cases={numeral(Info.todayRecovered).format(0, 0)}
                    ...
                    <InfoBoxes
                      ...
                      className="deaths"
                      title="Deaths  cases"
                      cases={numeral(Info.todayDeaths).format(0, 0)}
                    ...
                    <InfoBoxes
                      ...
                      className="active"
                      title="Active cases"
                      cases={numeral(Info.active).format(0, 0)}
                      total={numeral(Info.cases).format("0.0a")}
                    />
                  </div>
                </Animated>
                ...
                <div className="group-buttons">
                  <button
                    style={{ backgroundColor: "#3498DB", opacity: "0.8" }}
                    onClick={(e) => setCaseType("cases")}
                  >
                    Cases
                  </button>
                  <button
                    style={{ backgroundColor: "#2ECC71", opacity: "0.8" }}
                ...
                <div className="chart-boxes">
                  <Card>
                    <CardContent>
                      <Graph casesType2="cases"></Graph>
                    </CardContent>
                  </Card>
                  <Card>
                    <CardContent>
                      <Graph casesType2="recovered"></Graph>
                    </CardContent>
                  </Card>
                  <Card>
                    <CardContent>
                      <Graph casesType2="deaths"></Graph>
                    </CardContent>
                  </Card>
                </div>
              </div>
